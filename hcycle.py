...
@click.option('-em', '--energy-manager', is_flag=True, default=False,
              help='FLAG; Include energy manager data: off by default')
@click.option('-rnd', '--random', is_flag=True, default=False,
              help='FLAG; Randomize tint levels: each cycle will have a random value for target tint.')
...
@click.option('--debug', is_flag=True, default=False,
              help='FLAG; Used by the debugger. WARNING: Don\'t use outside of a development environment. You won\'t like the results.')
